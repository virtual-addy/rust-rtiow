...
This is an implementation of the [Ray Tracing In One Weekend](https://raytracing.github.io/books/RayTracingInOneWeekend.html) book series using Rust.
...
- `book-2-{section_number}-{section_name}`: contains only the changes for the section in book 2 `Ray Tracing: The Next Week`. Example: `book-2-3-bvh`
